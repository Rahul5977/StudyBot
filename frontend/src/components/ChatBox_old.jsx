...
//               Upload documents, ask questions, create study plans, or search for resources.
//             </p>
//             {useMultiAgent && (
//               <div className="mt-4 p-4 bg-blue-50 rounded-lg text-left max-w-md mx-auto">
//                 <h4 className="font-medium text-blue-800 mb-2">💡 Try these commands:</h4>
...
//               {/* Web Search Results */}
//               {message.type === "ai" && formatWebSearchResults(message.searchResults)}

//               {/* Context Chunks */}
//               {message.type === "ai" && formatContextChunks(message.contextChunks)}
...
//             Session ID: {sessionId.substring(0, 8)}... | Mode: {useMultiAgent ? "Multi-Agent" : "Simple RAG"}
//           </p>
//         )}
//       </div>
//     </div>
